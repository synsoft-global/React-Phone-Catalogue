...
export default function PhoneDetailComponent() {
           ...
           .then((response: any) => { 
            //  console.log('user data for edit profile is here ',response);
             if(response.statuscode){
                let temp  = response.phone_info[0];
  ...
  const Back = () =>{
   ...
   const editPhone = () =>{
     let temp = '/addPhone?phoneId='+query.phoneId
     history.push(temp);
    }
    ...
    const DeletePhoneDetail = () =>{
      if(state.deletePhone){
        ...
        var parameters = 'id='+query.phoneId;
                    ...
                    <Paper className={classes.paper}>
                          ...
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           ...
                           <Grid item xs={12} sm={12} md={12} lg={12}>
                             <AppBar position="static">
                                ...
                                <Button color="inherit" onClick={() =>DeletePhone()}><DeleteIcon/></Button>
                                <Button color="inherit" onClick={() =>editPhone()}><EditIcon/></Button>
                                </Toolbar>
                             </AppBar>
                            </Grid>
                            <Grid item xs={12} sm={3} md={3} lg={3}>
                              <img className="imageWidth2" src={BASE_URL + '/uploads/'+ state.image} alt={state.image} />
                          </Grid>
                       ...
                       <Grid container direction="row">
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.body).dimensions} mm
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.body).wight}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.body).build}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.body).sim}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.display).type} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.display).size}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.display).resolution}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.display).protection}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           ...
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.platefrom).chipset}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.platefrom).cpu}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.platefrom).gpu}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.memory).cardslote} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.memory).internal}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           ...
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.mainCamera).video}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           ...
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.selfieCamera).video}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.sound).loudspeaker} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.sound).jack}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.comms).wlan} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.comms).bluetooth}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.comms).gps}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.comms).nfc}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.comms).radio}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.comms).usb}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                        ...
                        <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.bettery).type} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.bettery).charging}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.bettery).standby}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.bettery).musicPlay}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />
                         ...
                         <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.misc).color} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.misc).model}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.misc).sar_eu}
                           </p>
                           <p className="detailText ptag2">
                         ...
                         <Grid container direction="row">
                          ...
                          <Grid item xs={12} sm={8} md={8} lg={8}>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.tests).performance} 
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.tests).display}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.tests).camera}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.tests).loudspeaker}
                           </p>
                           <p className="detailText ptag2">
                             {jsonParser(state.phoneDeta.tests).audioQuelity}
                           </p>
                          </Grid>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                           <Divider /><Divider />

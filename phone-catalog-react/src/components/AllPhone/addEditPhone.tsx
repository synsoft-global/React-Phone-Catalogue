...
import {Grid,Select,Button,
 TextField,InputLabel,FormHelperText,
 Paper,IconButton,MenuItem,FormControl,Divider
...
export default function AddEditPhone() {
  ...
  const [announcedDate, setSelectedDate] = React.useState<Date | null>(
    new Date(),
  );
  const [releaseDate, setSelectedDate1] = React.useState<Date | null>(
    new Date(),
  );
   ...
   return ( 
            ...
            <Grid container direction="row">
               <Grid item xs={12} sm={12} md={12} lg={12}>
                  ...
                  </IconButton>  {state.header} Phone Catalog list </p>
                </Grid>
                <Grid item xs={12} sm={12} md={12} lg={12}>
                     ...
                     <Grid item xs={12} sm={12} md={6} lg={6}>
                        <div className="fileUpload btn btn-primary">
                          <label className="upload">
                            <input type="file" id="uploadImage" multiple={false} accept={"image/*"}  onChange={uploadsImage('image')} />
                      ...
                      <Grid item xs={12} sm={12} md={6} lg={6}>
                        <Grid container direction="row">
                           <Grid item xs={12} sm={12} md={12} lg={12}>
                            <TextField className="Margin8px width" id="name" value={state.name} onChange={handleChange('name')} type="text" label="name" onKeyUp={onKeyUp('name')} onBlur={onKeyUp('name')} error={state.nameError} required helperText={state.nameError ? 'Phone name is required !': '' } inputProps={{maxLength: 50,minLength: 1, }} />
                          ...
                          <Grid item xs={12} sm={12} md={12} lg={12}>
                          <FormControl className={classes.formControl} required error={state.neworkError} >
                              ...
                              >
                                {NetworkData.map(item => <MenuItem key="{item}" value={item.name}> <span className="BoldText"> {item.name} - </span>  {item.values}</MenuItem>)}
                              </Select>
                              <FormHelperText>{state.neworkError ? 'Network technology is required !' : ''}</FormHelperText>
                          </FormControl>
                          </Grid>
                        </Grid>
                      ...
                      <Grid item xs={12} sm={12} md={4} lg={4}>
                         <FormControl className={classes.formControl} required error={state.statusError}>
                            ...
                            >
                             ...
                             <FormHelperText> {state.statusError ? 'Status is required!': ''}</FormHelperText>
                        </FormControl>
                      </Grid>
                      <Grid item xs={12} sm={12} md={4} lg={4}>
                         <MuiPickersUtilsProvider utils={DateFnsUtils}>
                     ...
                     <Grid container direction="row" spacing={0}>
                      ...
                      <Grid item xs={12} sm={12} md={12} lg={12}>
                          <Grid container spacing={0}>
                            ...
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="diamention1" value={state.diamention1} onChange={handleChange('diamention1')} className="width100" type="number" label="Dimension (in mm)" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="diamention2" value={state.diamention2} onChange={handleChange('diamention2')} className="width100" type="number" label="Dimension (in mm)" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="diamention3" value={state.diamention3} onChange={handleChange('diamention3')} className="width100" type="number" label="Dimension (in mm)" />
                            </Grid>
                          </Grid>
                      </Grid>
                      <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" value={state.weight} onChange={handleChange('weight')} id="weight" type="text" label="Weight" onKeyUp={onKeyUp('weight')} onBlur={onKeyUp('weight')} error={state.weightError} required helperText={state.weightError ? 'Phone weight is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="build" value={state.build} onChange={handleChange('build')} className="Margin8px width100" type="text" label="Build" onKeyUp={onKeyUp('build')} onBlur={onKeyUp('build')} error={state.buildError} required helperText={state.buildError ? 'Phone build info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="sim" value={state.sim} onChange={handleChange('sim')}  className="Margin8px width100" type="text" label="SIM" onKeyUp={onKeyUp('sim')} onBlur={onKeyUp('sim')} error={state.simError} required helperText={state.simError ? 'Phone sim info is required !': '' } />
                          </Grid>
                     </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        ...
                        <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField className="Margin8px" value={state.dType} onChange={handleChange('dType')} id="dType" type="text" label="Type" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField id="dSize" value={state.dSize} onChange={handleChange('dSize')} className="Margin8px" type="text" label="Size" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField id="dResolution" value={state.dResolution} onChange={handleChange('dResolution')}  className="Margin8px" type="text" label="Resolution" />
                          </Grid>
                          <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField id="dProtection" value={state.dProtection} onChange={handleChange('dProtection')}   className="Margin8px" type="text" label="Protection" />
                          </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        ...
                        <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField className="Margin8px" value={state.os} onChange={handleChange('os')} id="os" type="text" label="OS" onKeyUp={onKeyUp('os')} onBlur={onKeyUp('os')} error={state.osError} required helperText={state.osError ? 'Phone OS info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField id="chipSet" value={state.chipSet} onChange={handleChange('chipSet')}  className="Margin8px" type="text" label="Chipset" onKeyUp={onKeyUp('chipSet')} onBlur={onKeyUp('chipSet')} error={state.chipsetError} required helperText={state.chipsetError ? 'Phone chipSet info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField id="cpu" value={state.cpu} onChange={handleChange('cpu')} className="Margin8px" type="text" label="CPU"  onKeyUp={onKeyUp('cpu')} onBlur={onKeyUp('cpu')} error={state.cpuError} required helperText={state.cpuError ? 'Phone cpu info is required !': '' }/>
                          </Grid>
                          <Grid item xs={12} sm={12} md={3} lg={3}>
                              <TextField id="gpu" value={state.gpu} onChange={handleChange('gpu')} className="Margin8px" type="text" label="GPU" onKeyUp={onKeyUp('gpu')} onBlur={onKeyUp('gpu')} error={state.gpuError} required helperText={state.gpuError ? 'Phone gpu info is required !': '' } />
                          </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                         <Grid item xs={12} sm={12} md={12} lg={12}>
                          ...
                          <Grid item xs={12} sm={12} md={4} lg={4}>
                            ...
                            <Grid item xs={12} sm={12} md={8} lg={8}>
                              <TextField id="internalMemory" value={state.internalMemory} onChange={handleChange('internalMemory')}  className="Margin15px width100" type="text" label="Internal" onKeyUp={onKeyUp('internalMemory')} onBlur={onKeyUp('internalMemory')} error={state.internalMemoryError} required helperText={state.internalMemoryError ? 'Phone Internal memory info is required !': '' } />
                            </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" value={state.main_camera_triple} onChange={handleChange('main_camera_triple')} id="main_camera_triple" type="text" label="Triples" onKeyUp={onKeyUp('main_camera_triple')} onBlur={onKeyUp('main_camera_triple')} error={state.main_camera_tripleError} required helperText={state.main_camera_tripleError ? 'MAIN CAMERA info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="main_camera_feature" value={state.main_camera_feature} onChange={handleChange('main_camera_feature')}  className="Margin8px width100" type="text" label="Features" onKeyUp={onKeyUp('main_camera_feature')} onBlur={onKeyUp('main_camera_feature')} error={state.main_camera_featureError} required helperText={state.main_camera_featureError ? 'MAIN CAMERA Features info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="main_camera_video" value={state.main_camera_video} onChange={handleChange('main_camera_video')} className="Margin8px width100" type="text" label="Video" onKeyUp={onKeyUp('main_camera_video')} onBlur={onKeyUp('main_camera_video')} error={state.main_camera_videoError} required helperText={state.main_camera_videoError ? 'MAIN CAMERA Video info is required !': '' } />
                          </Grid> 
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" value={state.selfi_camera_single} onChange={handleChange('selfi_camera_single')} id="selfi_camera_single" type="text" label="Single" onKeyUp={onKeyUp('selfi_camera_single')} onBlur={onKeyUp('selfi_camera_single')} error={state.selfi_camera_singleError} required helperText={state.selfi_camera_singleError ? 'SELFIE CAMERA  info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="selfi_camera_feature" value={state.selfi_camera_feature} onChange={handleChange('selfi_camera_feature')} className="Margin8px width100" type="text" label="Features" onKeyUp={onKeyUp('selfi_camera_feature')} onBlur={onKeyUp('selfi_camera_feature')} error={state.selfi_camera_featureError} required helperText={state.selfi_camera_featureError ? 'SELFIE CAMERA Features info is required !': '' } />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="selfi_camera_video" value={state.selfi_camera_video} onChange={handleChange('selfi_camera_video')}   className="Margin8px width100" type="text" label="Video" onKeyUp={onKeyUp('selfi_camera_video')} onBlur={onKeyUp('selfi_camera_video')} error={state.selfi_camera_videoError} required helperText={state.selfi_camera_videoError ? 'SELFIE CAMERA video info is required !': '' } />
                          </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                         <Grid item xs={12} sm={12} md={12} lg={12}>
                          ...
                          <Grid item xs={12} sm={12} md={4} lg={4}>
                            ...
                            <Grid item xs={12} sm={12} md={8} lg={8}>
                              <TextField id="loaudSpeaker"  value={state.loaudSpeaker} onChange={handleChange('loaudSpeaker')} className="Margin15px width100" type="text" label="Loudspeaker" />
                            </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" value={state.wlan} onChange={handleChange('wlan')} id="wlan" type="text" label="WLAN" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="bluetooth" value={state.bluetooth} onChange={handleChange('bluetooth')}  className="Margin8px width100" type="text" label="Bluetooth" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="gps" value={state.gps} onChange={handleChange('gps')}  className="Margin8px width100" type="text" label="GPS" />
                          </Grid>
                          <Grid item xs={12} sm={12} md={4} lg={4}>
                            <FormControl className={classes.formControl}>
                            ...
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="usb" value={state.usb} onChange={handleChange('usb')} className="Margin15px width100" type="text" label="USB" />
                          </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <FormControl className={classes.formControl}>
                      ...
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                          ...
                          <Divider />
                            ...
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                              <TextField id="sensors" multiline  className="Margin8px width100" type="text" value={state.sensors} onChange={handleChange('sensors')} label="Sensors" />
                            </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                          ...
                          <Divider />
                            ...
                            <Grid item xs={12} sm={6} md={3} lg={3}>
                              <TextField id="batteryType" multiline value={state.batteryType} onChange={handleChange('batteryType')}  className="Margin8px width100" type="text" label="Type" />
                            </Grid>
                            <Grid item xs={12} sm={6} md={3} lg={3}>
                              <TextField id="batterCharging"  value={state.batterCharging} onChange={handleChange('batterCharging')}  multiline  className="Margin8px width100" type="text" label="Charging" />
                            </Grid>
                            <Grid item xs={12} sm={6} md={3} lg={3}>
                              <TextField id="stand_by" multiline value={state.stand_by} onChange={handleChange('stand_by')}  className="Margin8px width100" type="text" label="Stand-by" />
                            </Grid>
                            <Grid item xs={12} sm={6} md={3} lg={3}>
                              <TextField id="music_play"  value={state.music_play} onChange={handleChange('music_play')}  multiline  className="Margin8px width100" type="text" label="Music play" />
                            </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" id="color" type="text" label="Colors" value={state.color} onChange={handleChange('color')}  />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="model" value={state.model} onChange={handleChange('model')} className="Margin8px width100" type="text" label="Models" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="price" value={state.price} onChange={handleChange('price')} className="Margin8px width100" type="text" label="Price" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12}>
                          <Grid container spacing={0}>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                            ...
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="head" value={state.head} onChange={handleChange('head')} className="width100" type="text" label="Head" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="body" value={state.body} onChange={handleChange('body')} className="width100" type="text" label="Body" />
                            </Grid>
                          </Grid>
                      </Grid>
                      <Grid container direction="row" spacing={0}>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                          ...
                          <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" id="performance" type="text" label="Performance" value={state.performance} onChange={handleChange('performance')}  />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="display" value={state.display} onChange={handleChange('display')} className="Margin8px width100" type="text" label="Display" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="camera" value={state.camera} onChange={handleChange('camera')} className="Margin8px width100" type="text" label="Camera" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField className="Margin8px width100" id="loaud_speker" type="text" label="Loaudspeker" value={state.loaud_speker} onChange={handleChange('loaud_speker')}  />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="audio_quelity" value={state.audio_quelity} onChange={handleChange('audio_quelity')} className="Margin8px width100" type="text" label="Audio Quelity" />
                            </Grid>
                            <Grid item xs={12} sm={12} md={4} lg={4}>
                              <TextField id="battery_life" value={state.battery_life} onChange={handleChange('battery_life')} className="Margin8px width100" type="text" label="Battery Life" />
                            </Grid>
                      </Grid>
                      </Grid>
                       <Grid container direction="row" spacing={0}>
